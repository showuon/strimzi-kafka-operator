...
public class TieredStorageST extends AbstractST {
    ...
    void setup() throws IOException {
        ...
        LOGGER.info("!!! Environment.KAFKA_TIERED_STORAGE_BASE_IMAGE:" + Environment.KAFKA_TIERED_STORAGE_BASE_IMAGE_DEFAULT + ";;" + Environment.KAFKA_TIERED_STORAGE_BASE_IMAGE);
